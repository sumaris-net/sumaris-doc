...
- Ajout de grant sur `ACTIVITY_CALENDAR2PERSON` :
  ...
  grant SELECT,INSERT,UPDATE,DELETE on SIH2_ADAGIO_DBA.ACTIVITY_CALENDAR2PERSON to SIH2_ADAGIO_BATCH;
  grant SELECT on SIH2_ADAGIO_DBA.ACTIVITY_CALENDAR2PERSON to SIH2_ADAGIO_PRO;  
-```
