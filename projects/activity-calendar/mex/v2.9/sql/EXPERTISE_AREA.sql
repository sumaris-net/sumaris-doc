...
insert into EXPERTISE_AREA2LOCATION (EXPERTISE_AREA_FK, LOCATION_FK) select ID, 54 from EXPERTISE_AREA where LABEL='MYT';
insert into EXPERTISE_AREA2LOCATION (EXPERTISE_AREA_FK, LOCATION_FK) select ID, 39 from EXPERTISE_AREA where LABEL='MYT';
-- Méditerranée
...
insert into EXPERTISE_AREA2LOCATION (EXPERTISE_AREA_FK, LOCATION_FK) select ID, 4021 from EXPERTISE_AREA where LABEL='ATL';
...
-- Mayotte|101;105;165;166
insert into EXPERTISE_AREA2LOCATION_LEVEL(EXPERTISE_AREA_FK, LOCATION_LEVEL_FK)select ID,101 from EXPERTISE_AREA where LABEL = 'MYT';
...
-- Mer du nord manche atlantique|101;113;114;117
insert into EXPERTISE_AREA2LOCATION_LEVEL(EXPERTISE_AREA_FK, LOCATION_LEVEL_FK) select ID,101 from EXPERTISE_AREA where LABEL = 'ATL';
