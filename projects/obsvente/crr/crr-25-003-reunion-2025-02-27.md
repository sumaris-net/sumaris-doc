...
- **Vente**
  ...
  - **Vente** > Ecran "Détails" : 
    ...
    - Possibilités de saisir plusieurs zones de pêche
      ...
      >   - Comment est configurer le niveau de lieu dans la zone de pêche
      >   - _sumaris.sale.fishing_area.level.ids_ à créer (voir l'option landing) 111,141
      > - Ticket #692
  ...
  - **Vente** > Ecran "Lots" : RAS
    ...
    > - Ticket [#1025](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/1025)
...
- Livrer l'application Opus ObsVentes dans l'environnement Ifremer
    ...
    - Prévoir un point avec les utilisateurs de Méditérranée (le 07/04/2024)
