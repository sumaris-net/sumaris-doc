...
| Sprint 4     | 21/06/2024    | 2.9.19        | 09/07/2024               | -                                | Closed                    |
| Sprint 5     | 12/07/2024    | 2.9.20.1      | -                        | -                                | Testing Env.              |
| Sprint 6     | 09/08/2024    | **2.9.21**    | -                        | -                                | Release Waiting           |
| **Sprint 7** | 19/08/2024    | 2.9.22        | -                        | To defined                       | **On going**              |
...
- **Milestone** : 2.9.19
- **Status** : Close
- **Goal** : Gestion PERTS / Espèces tirées au sort
- **Deployement** : **Done**
...
| **Open**                                                                          | **To Do**                                                                         | **Doing**                                                                         | **Done**                                                                          | **Testing** | **Waiting** | **Closed** |
|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-------------|-------------|------------| 
| Rec [#596](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/596)  | Enh [#548](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/548) | Enh [#541](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/541) | Enh [#606](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/606)  |             |             |    Rec [#589](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/589)        | 
| | Enh [#560](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/560) | Enh [#542](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/542) |     Enh [#608](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/608)                                                                               |             |             |   Enh [#598](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/598)         |
|                                                                                   | Enh [#614](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/614) |  |                                                                                  |             |             |            |
|                                                                                   | Enh [#619](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/619)  | |                                                                                  |             |             |            |
<!-- .element: class="font-size-small" -->
...
Fonctionnalités sur sprint 5 :
- Retours de recette
- Echantillonnage
  - Problème de tri
  - Outremer
  - Filtrer les PETS lors de l'ajout
  - Ajout par lot
- Erreur à la sauvegarde de la vente (SALE_TYPE négatif)
- Sauvegarde de la vente : pas de lien avec le débarquement
...
- **Goal** :
- **Deployement** : -
- [gitlab Issues board](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/boards/873?label_name[]=OBSVENTES&milestone_title=2.9.21)

---

| **Open** | **To Do**                                                                         | **Doing**                                                                         | **Done**                                                                          | **Testing** | **Waiting** | **Closed** |
|----------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-------------|-------------|------------| 
|          |  | Enh [#660](https://gitlab.ifremer.fr/sih-public/sumaris/sumaris-app/-/issues/660) |  |             |             |            | 
<!-- .element: class="font-size-small" -->

---

Fonctionnalités sur sprint 6 :
- A COMPLETER